...
class MultiClassToBanditReduction(BaseSyntheticBanditDataset):
    ...
    Note
    -----
    Here we describe an overall flow of using multi-class classification data as logged bandit feedback to evaluation the performance of OPE.
    ...
    alpha_b: list, int, or float, default=0.8
        ...
        Must be in the [0, 1] interval. Note that a value in the [0, 1) interval
        should be set to make the behavior policies stochastic ones.
    ...
    .. code-block:: python
        ...
        >>> relative_ee = ope.evaluate_performance_of_estimators(
    ...
    def obtain_action_dist_by_eval_policy(
        ...
        base_classifier_e: ClassifierMixin, default=None
            Machine learning classifier used to construct an evaluation policy.
    ...
    def calc_ground_truth_policy_value(self, action_dist: np.ndarray) -> np.ndarray:
        ...
        ), f"action_dist must be a 3-dimensional np.ndarray"
        assert (
